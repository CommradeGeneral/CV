...
\begin{tikzpicture}
	...
	\node [anchor = north west, inner sep = 0pt,scale = 1.6] (name) at (left) {%
        ...
        \node [anchor = north west, inner sep = 1ex] (info0) at ([yshift = -1ex] title.south west) {
            ...
            \item[\faMapMarker*] Cairo \par Mit Ghamr - Dakahliyya \item[\faMobile*] 01008424732  - 01559544732             
...
{	\color{light}\dotfill}\smallskip 
   ...
   \item Conduct scheduled and preventive maintenance for various elevator systems to maximize
...
{	\color{light}\dotfill}\smallskip 
   ...
   \item Supported installation and commissioning of elevator systems for 4000+ units of same Fuji product.
                            ...
                            \item Reviewed user manuals and circuit diagrams for installation accuracy.
                        	 \end{itemize}
\end{expbox}
\begin{expbox}[title = {\bfseries Entry Level Maintenance Engineer}]
...
{	\color{light}\dotfill}\smallskip 
	 \begin{itemize}[nosep,align = left, leftmargin = !, labelwidth = \widthof{L:}]\raggedright
   \item Conduct scheduled and preventive and predictive maintenance for various machines to maximize
                                    reliability and extend product life.
                            \item Replace damaged or expired components to ensure operational safety, and
                                    recommend upgrades if possible.
                            \item Manage spare parts inventory and ensure cost-effective procurement of tools and equipment.
...
\begin{description}[nosep, align = left, style=nextline]\raggedright
	...
	\inlineitemi[5]{Relay Logic Control (Classic Control)}
...
\begin{expbox}[title = {\bfseries\raggedright Industrial Automation (PLC advanced)}]
	...
	\begin{itemize}[nosep,align = left, leftmargin = !, labelwidth = \widthof{L:}]\raggedright
		\item[\faCalendar*] 5/4/2025 - 23/9/2025
...
\begin{itemize}[nosep,align = left, leftmargin = !, labelwidth = \widthof{L:}]\raggedright
            ...
            \item[\faMapMarker*] Cairo \par Mit Ghamr - Dakahliyya
